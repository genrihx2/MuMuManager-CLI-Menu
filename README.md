...
- Показывается сообщение последнего коммита
- Перед перезаписью **предыдущие версии сохраняются** в `backup\<дата_время>\`
- Каждый скачанный файл **проверяется на корректность** перед записью
...
- [VirusTotal](https://www.virustotal.com/gui/file/b9a6e2ad2e1f2c9548d5d3fa25478ec593fc6815d29243903656c1da47f3a2fc): **0 malicious / 0 suspicious** (59+ движков)
